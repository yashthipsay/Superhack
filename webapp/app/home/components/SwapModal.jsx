    ...
    <div className='swap-body'>
        ...
        <div className="swap">
          <div className="swap-bar">
            ...
            <div className="available">
              ...
              <div className="available-amount">0 OSMO</div>
            ...
            <div className="chain">
              <div className='chain-options'>
                ...
                <select className="chain-name"  value='Osmo' >
                  <option value="Osmo">Osmo</option>
                </select>
              </div>
              <div className="amount">
                <div className="number">0</div>
                <div className="dollar-conversion">= $0</div>
              </div>
            </div>
        </div>
      ...
      <div className="swap-details">
        <div className="grid">
          ...
          <div className="grid-text">1 OSMO = 0.002 WETH <br/> <div className='grid-text sub'> 1 OSMO = 494.409 WETH </div></div>
        </div>  

        <div className="grid">
          <div className="grid-text">Swap fee</div>
          <div className="grid-text">0.2 %</div>
        </div>

        <div className="grid">
          <div className="bold">Estimated Slippage</div>
        </div>
        ...
        <div className="stats-top">
          <div className='stats-top-section'>
            ...
            <div className="curr-price">
              <div className="curr-logo"><EtherSVG /></div>
            ...
            <div className="blocks-table-row">
                <div className="row-left">
                  <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22 22" fill="none">
                   <path fill-rule="evenodd" clip-rule="evenodd" d="M20.1663 22H4.58301C3.06409 22 1.83301 20.7689 1.83301 19.25V2.75C1.83301 1.23108 3.06409 0 4.58301 0H20.1663V22ZM18.333 18.3333H5.03676C3.77634 18.3333 3.77634 20.1667 5.03676 20.1667H18.333V18.3333ZM18.333 1.83333H4.58301V16.5H18.333V1.83333ZM15.583 4.58333V7.33333H7.33301V4.58333H15.583Z" fill="#838282"/>
                  </svg>
